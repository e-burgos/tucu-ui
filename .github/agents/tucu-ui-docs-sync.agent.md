...
1. `.github/skills/tucu-ui-docs/SKILL.md` — Documentation patterns, section templates, TOC, lazy loading, page types
2. `.github/skills/tucu-ui-catalog/SKILL.md` — Full component catalog, props, categories
3. `.github/skills/tucu-ui/SKILL.md` — Overview, installation, architecture
