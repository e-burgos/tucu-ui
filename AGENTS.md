...
| `ui/tucu-docs/`     | `tucu-docs`             | `@e-burgos/tucu-docs`       | app (docs site)       | Public docs site (ui.estebanburgos.com.ar). Consumes `tucu-ui` + MCP resources to render live examples. Not published to npm. |
...
| **13 Resources** | `tucu://catalog`, `tucu://datatable`, `tucu://tokens`, `tucu://forms`, `tucu://routing`, `tucu://layouts`, `tucu://theme`, `tucu://charts`, `tucu://icons`, `tucu://migration`, `tucu://best-practices`, `tucu://changelog`, `tucu://quickstart` |
