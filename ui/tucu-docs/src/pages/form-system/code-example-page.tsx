import { ErrorContainerExample } from '@tucu-ui-internal/components/forms/example/error-container-example';
import { FormMethodsExample } from '@tucu-ui-internal/components/forms/example/form-methods-example';
import { type FormValues } from '@tucu-ui-internal/components/forms/example/validations';

import formExampleCode from '@tucu-ui-internal/components/forms/example/form-example.tsx?raw';
import errorContainerCode from '@tucu-ui-internal/components/forms/example/error-container-example.tsx?raw';
import formMethodsCode from '@tucu-ui-internal/components/forms/example/form-methods-example.tsx?raw';
import constantsCode from './example/constants.ts?raw';
import validationsCode from '@tucu-ui-internal/components/forms/example/validations.ts?raw';
