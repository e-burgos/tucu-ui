...
import { ParamTab, TabPanel } from '@tucu-ui-internal/components/tabs';
...
const { Home, Settings, User, BarChart, FileText, Bell } = LucideIcons;
...
const ParamTabSection: React.FC = () => {
  ...
  return (
    <>
      <HeroCard
        title="ParamTab"
        description="A powerful tab component that automatically syncs with URL query
          parameters and switches to a dropdown selector on mobile devices for
          optimal responsive behavior."
        icon={
          <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-linear-to-br from-purple-600 to-indigo-500 rounded-full flex items-center justify-center shadow-lg">
            <LucideIcons.Hash className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white filter drop-shadow-lg" />
          </div>
        }
      />
