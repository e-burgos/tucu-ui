...
const ButtonDripSection: React.FC = () => {
  return (
    <>
      <HeroCard
        title="ButtonDrip"
        description="A button effect component that creates a ripple animation on click."
        icon={
          <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-linear-to-br from-blue-500 to-indigo-500 rounded-full flex items-center justify-center shadow-lg">
            <LucideIcons.MousePointerClick className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white filter drop-shadow-lg" />
          </div>
        }
      />
