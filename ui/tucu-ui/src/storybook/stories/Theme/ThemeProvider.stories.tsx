        ...
        component: (
          <CardContainer className="flex flex-col gap-4">
            ...
            <p className="text-base text-gray-600">
              ...
              Headless UI and styled with Tailwind CSS. Each component is
        ...
        dropdownItems: [
          {
            ...
            component: (
              <CardContainer className="flex flex-col gap-4">
                ...
                <p className="text-base text-gray-600">
                  tucu-ui provides versatile button components with support for
                  various shapes, sizes, variants, and colors. Buttons include
                  loading states, animations, and tooltip support.
                </p>
          ...
          },
          {
            ...
            component: (
              <CardContainer className="flex flex-col gap-4">
                ...
                <p className="text-base text-gray-600">
                  tucu-ui extends Headless UI components with additional styling
                  and functionality. These components provide accessible,
                  unstyled building blocks that you can customize to match your
                  design system.
                </p>
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 mt-2">
            ...
            component: (
              <CardContainer className="flex flex-col gap-4">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 mt-2">
                  ...
                  <ul className="list-disc pl-5 text-sm text-gray-500">
                    <li>
                      <strong>Classic:</strong> Traditional layout with sidebar
                      and header
                    </li>
                    <li>
      ...
      },
      {
        ...
        component: (
          <CardContainer className="flex flex-col gap-4">
            ...
            <p className="text-base text-gray-600">
              tucu-ui includes a powerful theming system built on Tailwind CSS.
              You can customize colors, typography, spacing, and more to match
              your brand. The theme provider component makes it easy to switch
              between themes and manage settings.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
  ...
  htmlTag.classList.add('light');
            ...
            <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 mt-2">
              ...
              <p className="text-sm text-gray-600 mb-2">
                ...
                and Right-to-Left (RTL) text directions, making it suitable for
            ...
            component: (
              <CardContainer className="flex flex-col gap-4">
                ...
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 mt-2">
                  ...
                  <ul className="list-disc pl-5 text-sm text-gray-500">
                    <li>
                      <strong>Theme Settings:</strong> Mode, layout, direction,
                      color preset
                    </li>
                    <li>
            ...
            component: (
              <CardContainer className="flex flex-col gap-4">
                ...
                <p className="text-base text-gray-600">
                  ...
                  color presets. You can choose from predefined color schemes or
                  create your own.
                </p>
                <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4 mt-2">
                  ...
                  <ul className="list-disc pl-5 text-sm text-gray-500">
                    <li>
                      <strong>Presets:</strong> Green, Black, Blue, Red, Purple,
                      Orange
                    </li>
                    <li>
        ...
        component: (
          <CardContainer className="flex flex-col gap-4">
            ...
            <p className="text-base text-gray-600">
              ...
              This guide covers installation, configuration, and basic usage to
