...
const ScrollbarSection: React.FC = () => {
  ...
  return (
    <>
      <HeroCard
        title="Scrollbar"
        description="A customizable scrollbar component with auto-hide functionality and
          custom styling options."
        icon={
          <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-linear-to-br from-teal-600 to-emerald-500 rounded-full flex items-center justify-center shadow-lg">
            <LucideIcons.ScrollText className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-white filter drop-shadow-lg" />
          </div>
        }
      />
