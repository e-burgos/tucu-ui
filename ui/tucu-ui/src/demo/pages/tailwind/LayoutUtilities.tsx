        ...
        <section className="space-y-6">
          ...
          <CardContainer>
            <CardTitle title="Flexbox Utilities">
              <div className="space-y-4">
                <div className="flex gap-2 p-4 bg-light-dark rounded">
                ...
                <div className="flex flex-col gap-2 p-4 bg-light-dark rounded">
          ...
          <CardContainer>
            <CardTitle title="Grid Utilities">
              <div className="space-y-4">
                <div className="grid grid-cols-3 gap-2 p-4 bg-light-dark rounded">
                ...
                <div className="grid grid-cols-2 grid-rows-2 gap-2 p-4 bg-light-dark rounded h-24">
                  <div className="bg-red-500/20 p-2 rounded text-center text-xs">
                    1
                  </div>
                  <div className="bg-yellow-500/20 p-2 rounded text-center text-xs">
