  ...
  return (
    <>
      <div className="text-center space-y-4">
        ...
        >
          A native-style segmented control for mutually exclusive selections,
          available in three sizes with optional icons.
        </Typography>
      </div>
              ...
              options={[
                {
                  value: 'list',
                  label: 'List',
                  icon: <LucideIcons.List className="w-3.5 h-3.5" />,
                },
                {
                  value: 'grid',
                  label: 'Grid',
                  icon: <LucideIcons.Grid3X3 className="w-3.5 h-3.5" />,
                },
                {
                  value: 'columns',
                  label: 'Columns',
                  icon: <LucideIcons.Columns className="w-3.5 h-3.5" />,
                },
              ]}
              value={view}
