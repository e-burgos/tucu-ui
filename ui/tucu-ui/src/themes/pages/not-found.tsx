...
import { Image, Button, AnchorLink } from '../../components';
...
export const NotFoundPage: FC<{ basePath?: string }> = ({ basePath }) => {
  const pathBase =
  ...
  return (
    <div className="bg-light-dark flex h-screen w-full flex-col items-center justify-center text-center absolute top-0 left-0">
      <div className="relative w-52 sm:w-[400px] xl:w-[450px] min-[1780px]:w-[500px]">
