...
const classes = {
  ...
  mark: '',
  abbr: 'cursor-help',
  pre: 'border-2 border-border py-3 px-4 rounded-xl dark:border-border dark:bg-gray-800 bg-gray-100',
  ...
  kbd: 'bg-gray-100 border border-border text-gray-900 rounded-lg leading-none inline-flex items-center justify-center text-sm py-1.5 px-2',
