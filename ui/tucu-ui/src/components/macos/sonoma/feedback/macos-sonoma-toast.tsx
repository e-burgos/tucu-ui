...
import {
  ...
  MacOSNotificationVariant,
} from './notification-banner';

// ─── Helpers ───────────────────────────────────────────────────

function mapVariant(variant: IToast['variant']): MacOSNotificationVariant {
  switch (variant) {
    case 'destructive':
      return 'error';
    case 'success':
...
export function MacOSSonomaToast() {
...
export default MacOSSonomaToast;
