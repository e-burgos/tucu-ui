            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="h-32 bg-gray-100 dark:bg-gray-800 rounded overflow-x-auto snap-x snap-mandatory">
                    <div className="flex gap-4 p-4">
                      <div className="w-32 h-24 bg-brand rounded flex-shrink-0 snap-center flex items-center justify-center text-white font-medium">
                        Snap 1
                      </div>
                      <div className="w-32 h-24 bg-green-500 rounded flex-shrink-0 snap-center flex items-center justify-center text-white font-medium">
                        Snap 2
                      </div>
                      <div className="w-32 h-24 bg-blue-500 rounded flex-shrink-0 snap-center flex items-center justify-center text-white font-medium">
                        Snap 3
                      </div>
                    </div>
                  </div>
          ...
          <CardTitle title="User Selection & Appearance">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded select-none">
                  <Typography tag="p" className="text-sm">
                    Cannot select this text
                  </Typography>
                </div>
                <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded select-text">
                  <Typography tag="p" className="text-sm">
                    Can select this text
                  </Typography>
                </div>
                <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded select-all">
                  <Typography tag="p" className="text-sm">
                    Select all on click
                  </Typography>
                </div>
                <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded appearance-none">
