              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="flex flex-row gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded">
                  ...
                  <div className="space-y-2">
                    <div className="flex flex-row-reverse gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded">
                      <div className="w-8 h-8 bg-brand rounded"></div>
                      <div className="w-8 h-8 bg-green-500 rounded"></div>
                      <div className="w-8 h-8 bg-blue-500 rounded"></div>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex flex-col gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded h-32">
                      <div className="w-8 h-8 bg-brand rounded"></div>
                      <div className="w-8 h-8 bg-green-500 rounded"></div>
                      <div className="w-8 h-8 bg-blue-500 rounded"></div>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex flex-col-reverse gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded h-32">
                      <div className="w-8 h-8 bg-brand rounded"></div>
                      <div className="w-8 h-8 bg-green-500 rounded"></div>
                      <div className="w-8 h-8 bg-blue-500 rounded"></div>
                    </div>
          ...
          <CardContainer>
            <CardTitle title="Flex Wrap">
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <div className="flex flex-wrap gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded max-w-xs">
                      {Array.from({ length: 8 }, (_, i) => (
                        <div
                          key={i}
                          className="w-8 h-8 bg-brand rounded flex-shrink-0"
                        ></div>
                      ))}
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex flex-nowrap gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded overflow-hidden max-w-xs">
                      {Array.from({ length: 8 }, (_, i) => (
                        <div
                          key={i}
                          className="w-8 h-8 bg-green-500 rounded flex-shrink-0"
                        ></div>
                      ))}
                    </div>
          ...
          <CardContainer>
            <CardTitle title="Flex Properties">
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <div className="flex gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded">
            ...
            <CardTitle title="Grid Template Columns">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    <div className="grid grid-cols-2 gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded">
                  ...
                  <div className="space-y-2">
                    <div className="grid grid-cols-3 gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded">
                  ...
                  <div className="space-y-2">
                    <div className="grid grid-cols-4 gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded">
                      {Array.from({ length: 8 }, (_, i) => (
                        <div
                          key={i}
          ...
          <CardContainer>
            <CardTitle title="Grid Auto Flow">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="grid grid-flow-row grid-cols-3 gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded h-32">
                      {Array.from({ length: 6 }, (_, i) => (
                        <div
                          key={i}
                          className="h-8 bg-brand rounded text-center text-xs text-white flex items-center justify-center"
                  ...
                  <div className="space-y-2">
                    <div className="grid grid-flow-col grid-cols-3 gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded h-32">
                      {Array.from({ length: 6 }, (_, i) => (
                        <div
                          key={i}
                          className="h-8 bg-green-500 rounded text-center text-xs text-white flex items-center justify-center"
          ...
          <CardContainer>
            <CardTitle title="Justify Content (Main Axis)">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="flex justify-start gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-center gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded">
                      <div className="w-6 h-6 bg-brand rounded"></div>
                      <div className="w-6 h-6 bg-green-500 rounded"></div>
                      <div className="w-6 h-6 bg-blue-500 rounded"></div>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-end gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded">
                      <div className="w-6 h-6 bg-brand rounded"></div>
                      <div className="w-6 h-6 bg-green-500 rounded"></div>
                      <div className="w-6 h-6 bg-blue-500 rounded"></div>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded">
                      <div className="w-6 h-6 bg-brand rounded"></div>
                      <div className="w-6 h-6 bg-green-500 rounded"></div>
                      <div className="w-6 h-6 bg-blue-500 rounded"></div>
                    </div>
          ...
          <CardContainer>
            <CardTitle title="Align Items (Cross Axis)">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    <div className="flex items-start gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded h-20">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded h-20">
                      <div className="w-6 h-12 bg-brand rounded"></div>
                      <div className="w-6 h-8 bg-green-500 rounded"></div>
                      <div className="w-6 h-16 bg-blue-500 rounded"></div>
                    </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-end gap-2 p-3 bg-gray-100 dark:bg-gray-800 rounded h-20">
                      <div className="w-6 h-12 bg-brand rounded"></div>
                      <div className="w-6 h-8 bg-green-500 rounded"></div>
                      <div className="w-6 h-16 bg-blue-500 rounded"></div>
                    </div>
          ...
          <CardContainer>
            <CardTitle title="Gap (Spacing)">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <div className="grid grid-cols-3 gap-1 p-3 bg-gray-100 dark:bg-gray-800 rounded">
                      <div className="w-6 h-6 bg-brand rounded"></div>
                      <div className="w-6 h-6 bg-green-500 rounded"></div>
                      <div className="w-6 h-6 bg-blue-500 rounded"></div>
                  ...
                  <div className="space-y-2">
                    <div className="grid grid-cols-3 gap-4 p-3 bg-gray-100 dark:bg-gray-800 rounded">
                      <div className="w-6 h-6 bg-brand rounded"></div>
                      <div className="w-6 h-6 bg-green-500 rounded"></div>
                      <div className="w-6 h-6 bg-blue-500 rounded"></div>
                      <div className="w-6 h-6 bg-purple-500 rounded"></div>
