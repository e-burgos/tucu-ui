    ...
    <div className="space-y-8 sm:space-y-12 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      <section className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {[
            {
              icon: <LucideIcons.Palette className="w-8 h-8 text-purple-500" />,
            ...
            {
              icon: <LucideIcons.Code className="w-8 h-8 text-blue-500" />,
            ...
            {
              icon: (
                <LucideIcons.Smartphone className="w-8 h-8 text-green-500" />
              ),
            ...
            {
              icon: <LucideIcons.Moon className="w-8 h-8 text-indigo-500" />,
            ...
            {
              icon: <LucideIcons.Eye className="w-8 h-8 text-red-500" />,
              title: 'Accessible',
              description:
    ...
    <ThemeProvider>
      ...
      <section className="space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
          {[
            {
              icon: <LucideIcons.Layout className="w-6 h-6" />,
              title: 'Layout',
            ...
            {
              icon: <LucideIcons.Navigation className="w-6 h-6" />,
              title: 'Navigation',
            ...
            {
              icon: <LucideIcons.MessageCircle className="w-6 h-6" />,
              title: 'Feedback',
            ...
            {
              icon: <LucideIcons.MousePointer className="w-6 h-6" />,
              title: 'Interactive',
            ...
            {
              icon: <LucideIcons.Coins className="w-6 h-6" />,
              title: 'Blockchain',
            ...
            {
              icon: <LucideIcons.Sparkles className="w-6 h-6" />,
              title: 'Utilities',
