  ...
  return (
    <div className="space-y-8 sm:space-y-12 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      <section className="relative overflow-hidden">
        <div className="relative bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 dark:from-emerald-900 dark:via-teal-900 dark:to-cyan-900 rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 overflow-hidden">
          ...
          <div className="relative text-center">
            <div className="flex justify-center mb-6">
              <div className="relative">
                <div className="w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 rounded-full flex items-center justify-center shadow-lg border border-white/20">
            ...
            >
              Comprehensive layout system with multiple presets, responsive
              design patterns, and powerful theme management. Built for
              flexibility, accessibility, and ease of customization.
            </Typography>
          </div>
        </div>
      </section>
